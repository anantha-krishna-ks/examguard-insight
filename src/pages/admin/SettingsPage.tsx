        ...
        <Card className="shadow-md border-0 bg-card/50 backdrop-blur">
          ...
          <CardContent>
            <Accordion type="multiple" className="w-full space-y-4" defaultValue={["response-time", "behavioral-pattern", "answer-similarity"]}>
              ...
              <AccordionItem value="response-time" className="border-[#E1E8ED] rounded-lg px-6 py-2 bg-[#F1F4F7]">
              ...
              <AccordionItem value="behavioral-pattern" className="border-[#E1E8ED] rounded-lg px-6 py-2 bg-[#F1F4F7]">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center space-x-3">
              ...
              <AccordionItem value="answer-similarity" className="border-[#E1E8ED] rounded-lg px-6 py-2 bg-[#F1F4F7]">
                <AccordionTrigger className="hover:no-underline">
                  <div className="flex items-center space-x-3">
